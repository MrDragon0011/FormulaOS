/* FormulaOS Virtual File System — persisted to localStorage */
const FormulaFS = (() => {
  const KEY = 'formulaos_fs_v1';

  const TRASH_META_KEY = 'formulaos_trash_meta_v1';
